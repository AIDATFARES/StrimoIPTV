...
export default function SupportCtaSection() {
  return (
    <section className="border-t border-white/10 bg-transparent px-5 py-16 sm:py-20 relative overflow-hidden">
      ...
      <div
        className="relative z-10 mx-auto flex max-w-[565px] flex-col gap-8 rounded-[22px] border border-[#36a9ff]/20 bg-[#051f33]/80 backdrop-blur-sm p-8 shadow-2xl sm:flex-row sm:items-center sm:justify-between sm:p-8 hover:border-[#36a9ff]/50 hover:shadow-[0_0_30px_rgba(54,169,255,0.15)] transition-all duration-300"
      >
        ...
        <div className="flex shrink-0 flex-col gap-2.5 sm:w-40">
          ...
          <a
            className="inline-flex items-center justify-center gap-2 rounded-full border border-white/10 px-4 py-2.5 text-[10px] font-extrabold uppercase tracking-wide text-white transition-all hover:border-[#36a9ff]/50 hover:bg-[#36a9ff]/10 hover:scale-105"
