...
export const metadata: Metadata = {
  title: "Realmiptv | #1 Premium 4K IPTV Subscription Service 2026",
  description: "Unlock premium entertainment with Realmiptv. Stream over 50,000 live international channels, 200,000 movies on demand, and major pay-per-view sports events with ultra-stable anti-freeze server technology and instant multi-device activation.",
  metadataBase: new URL("https://www.realmiptv4k.shop"),
  alternates: {
    canonical: "/",
  },
  openGraph: {
    title: "Realmiptv | #1 Premium 4K IPTV Subscription Service 2026",
    description: "Unlock premium entertainment with Realmiptv. Stream over 50,000 live international channels, 200,000 movies on demand, and major pay-per-view sports events with ultra-stable anti-freeze server technology and instant multi-device activation.",
    url: "https://www.realmiptv4k.shop",
    siteName: "Realmiptv",
    locale: "en_US",
    type: "website",
  },
        ...
        <footer className="w-full mt-auto border-t border-[#36a9ff]/20 bg-[#051f33]">
          <div className="grid max-w-[1400px] grid-cols-2 gap-x-4 gap-y-12 px-6 py-16 sm:grid-cols-4 sm:gap-x-8 sm:px-10 xl:grid-cols-[1.8fr_1fr_1fr_1fr_1fr] xl:gap-10 xl:px-12 mx-auto">
            ...
            <div className="col-span-1 min-w-0 space-y-6">
              <p className="text-xs font-extrabold uppercase tracking-[0.16em] text-white"><span className="border-b-2 border-[#36a9ff] pb-1.5">NAVIGATION</span></p>
            ...
            <div className="col-span-1 min-w-0 space-y-6">
              <p className="text-xs font-extrabold uppercase tracking-[0.16em] text-white"><span className="border-b-2 border-[#36a9ff] pb-1.5">SERVICE</span></p>
              <ul className="space-y-3 font-body-sm text-sm">
            ...
            <div className="col-span-1 min-w-0 space-y-6">
              <p className="text-xs font-extrabold uppercase tracking-[0.16em] text-white"><span className="border-b-2 border-[#36a9ff] pb-1.5">LEGAL</span></p>
            ...
            <div className="col-span-1 min-w-0 space-y-6">
              <p className="text-xs font-extrabold uppercase tracking-[0.16em] text-white"><span className="border-b-2 border-[#36a9ff] pb-1.5">PAYMENT</span></p>
